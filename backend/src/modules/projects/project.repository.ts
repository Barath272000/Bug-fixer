...
export const projectRepository = {
  ...
  create(ownerId: string, data: { name: string; sourceType: 'ZIP'|'GITHUB'|'PASTE'; repositoryUrl?: string|undefined; defaultBranch?: string|undefined }) { return prisma.project.create({ data: { ownerId, ...data } }); },
